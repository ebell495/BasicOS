build:
	...
	ld -melf_i386 -o "bin/kernel/kernel.bin" -Ttext 0x2000 "bin/kernel/kernelEntry.o" "bin/kernel/kernel.o"  "bin/kernel/display.o" "bin/kernel/hwio.o" "bin/kernel/ps2k.o" "bin/kernel/memlib.o" "bin/kernel/ata.o" --oformat binary
